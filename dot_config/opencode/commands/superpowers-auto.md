...
6. When dispatching subagent work, always use the `general` subagent, which defaults to the parent model. Do not use specialized or model-pinned subagent types.
